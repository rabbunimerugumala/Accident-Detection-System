    <h1 align="center">🛡️ LifeGuardX</h1>
    <h3 align="center">Intelligent Accident Detection & Real-Time Telemetry System</h3>

    <p align="center">
    <img src="https://img.shields.io/badge/ESP32--S3-Firmware-E7352C?logo=espressif&logoColor=white&style=for-the-badge" />
    <img src="https://img.shields.io/badge/React-18.3-61DAFB?logo=react&logoColor=white&style=for-the-badge" />
    <img src="https://img.shields.io/badge/Firebase-Realtime_DB-FFCA28?logo=firebase&logoColor=black&style=for-the-badge" />
    <img src="https://img.shields.io/badge/TypeScript-5.6-3178C6?logo=typescript&logoColor=white&style=for-the-badge" />
    <img src="https://img.shields.io/badge/Vite-6.0-646CFF?logo=vite&logoColor=white&style=for-the-badge" />
    </p>

    <p align="center">
    <i>"Detect the accident instantly, alert immediately, save the life before it's too late."</i>
    </p>
    ...
    **When offline:** All sensor cards immediately display zeros (not stale data), status badge turns red and pulses.
    ...
    <p align="center">
    Built with ❤️ for the community · <strong>LifeGuardX Pro Telemetry Dashboard</strong><br/>
    Open source road safety — because every second counts.<br/>
    <i>"Accidents NEVER go unnoticed. Victims NEVER stay without help."</i>
    </p>
